...
from .views import BooksListView, BookCreateView, BookUpdateView, BookDeleteView, BookDetailView, AuthorCreateView, \
    AuthorUpdateView, AuthorListView, ReviewBookView, RecommendBookView
